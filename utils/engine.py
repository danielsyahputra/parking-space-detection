...
def train_model(model, train_loader, valid_loader, test_loader, model_dir, device, 
                optimizer=torch.optim.AdamW, lr=1e-4, epoch=100, lr_decay=50, res=None, verbose=False):
